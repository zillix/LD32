package org.flixel
{
	...
	public class FlxObject extends FlxBasic
	{
		...
		protected function preCollideRight(obj:FlxObject) : Boolean
		{
			return true;
		}
		
		protected function preCollideLeft(obj:FlxObject) : Boolean
		{
			return true;
		}
		
		protected function preCollideTop(obj:FlxObject) : Boolean
		{
			return true;
		}
		
		protected function preCollideBottom(obj:FlxObject) : Boolean
		{
			return true;
		}
				...
				if((obj1rect.x + obj1rect.width > obj2rect.x) && (obj1rect.x < obj2rect.x + obj2rect.width) && (obj1rect.y + obj1rect.height > obj2rect.y) && (obj1rect.y < obj2rect.y + obj2rect.height))
				{
					...
					if(obj1delta > obj2delta)
					{
						...
						if ((overlap > maxOverlap) || 
							!(Object1.allowCollisions & RIGHT) || 
							!(Object1.preCollideRight(Object2)) ||
							!(Object2.allowCollisions & LEFT) ||
							!(Object2.preCollideLeft(Object1)))
							overlap = 0;
						else
						{
					...
					else if(obj1delta < obj2delta)
					{
						...
						if (( -overlap > maxOverlap) || 
						!(Object1.allowCollisions & LEFT) || 
						!(Object1.preCollideLeft(Object2)) ||
						!(Object2.allowCollisions & RIGHT) || 
						!(Object2.preCollideRight(Object1)))
							overlap = 0;
						else
						{
			...
			if(obj1delta != obj2delta)
			{
				...
				if((obj1rect.x + obj1rect.width > obj2rect.x) && (obj1rect.x < obj2rect.x + obj2rect.width) && (obj1rect.y + obj1rect.height > obj2rect.y) && (obj1rect.y < obj2rect.y + obj2rect.height))
				{
					...
					if(obj1delta > obj2delta)
					{
						...
						if ((overlap > maxOverlap) || 
						!(Object1.allowCollisions & DOWN) || 
						!(Object1.preCollideBottom(Object2)) ||
						!(Object2.allowCollisions & UP) ||
						!(Object2.preCollideTop(Object1)))
							overlap = 0;
						else
						{
					...
					else if(obj1delta < obj2delta)
					{
						...
						if (( -overlap > maxOverlap) || 
						!(Object1.allowCollisions & UP) || 
						!(Object1.preCollideTop(Object2)) ||
						!(Object2.allowCollisions & DOWN) ||
						!(Object2.preCollideBottom(Object1)))
							overlap = 0;
						else
						{
							Object1.touching |= UP;
